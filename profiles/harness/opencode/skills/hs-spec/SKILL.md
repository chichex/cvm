...
- Si por algun motivo `HAS_REPO=false`, abortar (cubierto por el pre-flight de `/hs-spec`); `/hs-spec` **no** tiene fallback inline.
...
- Leer el SKILL.md del skill hermano `/clarify` y seguir su protocolo.
