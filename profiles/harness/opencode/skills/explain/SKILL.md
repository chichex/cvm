---
name: explain
description: Explica un concepto, snippet, error o decision tecnica en 3 niveles de abstraccion crecientes (ELI5 / Dev junior / Experto) en una sola respuesta. One-shot. Usar cuando el usuario pide "explicame X", "no entiendo Y", "dame esto en varios niveles" o invoca el slash.
---

Explica un concepto, snippet de codigo, error o decision tecnica en **3 niveles de abstraccion crecientes** (ELI5 / Dev junior / Experto). One-shot: cada invocacion produce los 3 niveles en una sola respuesta y termina.
...
- Con argumento: explica el tema/concepto/snippet pasado.
- Sin argumento: explica lo ultimo relevante del contexto (ultimo mensaje del usuario, codigo que se esta viendo, error reciente). Citar al inicio que pedazo del thread se esta explicando.
