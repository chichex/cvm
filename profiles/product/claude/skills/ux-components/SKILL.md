Generar **componentes UI en HTML+Tailwind** que consumen un design system. Default: ~18 componentes esenciales (atoms responsive single-file + compounds dual-file cuando la interaccion difiere). Flags para limitar scope. `$ARGUMENTS` puede traer flags y/o lista de componentes especifica.
