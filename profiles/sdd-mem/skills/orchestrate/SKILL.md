...
**Nota**: este skill decide COMO ejecutar (directo vs subagent vs team). El auto-routing del CLAUDE.md decide QUE skill/fase del SDD usar. Son niveles distintos: auto-routing clasifica el intent (bug? feature? refactor?), `/orchestrate` elige la estrategia de paralelizacion dentro de una fase.
